...
function CreateListings() {
  ...
  return (
    <main className="mx-w-md px-2 mx-auto">
      <h1 className="text-3xl text-center mt-6 font-bold"> Create a Listing</h1>
      <form>
        <p className="text-lg mt-6  font-bold"> Sell / Rent</p>
        <div className="flex">
          <button
            type="button"
            id="type"
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg
                    focus:shadow-lg active:shadow-lg transistion duration-150 ease-in-out w-full
                     ${
                       type === "rent"
                         ? "bg-white text-black"
          ...
          <button
            ...
            value="sale"
            onClick={onChange}
            className={`ml-3 selection:px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg
                    focus:shadow-lg active:shadow-lg transistion duration-150 ease-in-out w-full
                     ${
                       type === "sale"
                         ? "bg-white text-black"
        ...
        <p className="text-lg mt-6  font-bold"> Parking Spot</p>
        <div className="flex">
          <button
            type="button"
            id="parking"
        ...
        <div className="flex items-center mb-6">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
                ...
                onChange={onChange} min ="50" max="400000000" required className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700
        ...
        <div className="flex items-center mb-6">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
                ...
                // required if offer is true as coded below line
                required  = {offer}
